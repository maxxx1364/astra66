...
OK   rest_mirror (0.57s)
OK   vision_archive (0.40s)
```
...
Data: **129,601** minutes (90.0 of 90 days requested) · 2026-06-20T00:17:00Z .. 2026-09-18T00:17:00Z · missing 0 min (0.0%) · source `https://data-api.binance.vision`

| configuration | trades | return% | Sharpe | maxDD% | win% | E[R] | PF |
|---|---:|---:|---:|---:|---:|---:|---:|
| strategy | 125 | -12.28 | -7.63 | 13.77 | 32.8 | -0.3622 | 0.40 |
| random_entry_control | 159 | -17.23 | -11.59 | 18.12 | 27.7 | -0.6249 | 0.33 |
| every_bar_control | 200 | -17.82 | -9.19 | 18.14 | 35.5 | -0.3216 | 0.47 |
